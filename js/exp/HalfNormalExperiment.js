...
var dxDist, yDist;
var x, y, z, s, ds, n = 200, xMax, t = 1, step;
var recordTable, currentRecord, completeRecord = "", header = "Run\tY";
...
function resetExperiment(){
	...
	yDist = new HalfNormalDistribution(Math.sqrt(t));
	xMax = 3 * Math.sqrt(t);
