//Triangle Distribution Experiment
var runID;
var runCount = 0, stopCount = 0, stopFreq = 10;
var currentRecord, completeRecord = "", header = "Run\tU\tX";
var dist, distTable, distGraph, quantileGraph;
var aParam, wParam, pParam;
var recordTable, triangleDistTable;
...
function initializeExperiment(){
	...
	pParam.setProperties(0, 1, 0.1, p, "<var>p</var>");
	resetExperiment();
}
